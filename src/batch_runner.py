...
def batch_process(input_folder, output_folder, max_workers=None):
    """Processes all SVGs in an input folder and saves to the output folder."""
    ...
    print(
        f"🚀 Found {len(svg_files)} files in '{input_folder}'. Starting batch processing...")
    ...
    with concurrent.futures.ProcessPoolExecutor(max_workers=max_workers) as executor:
        ...
        futures = {executor.submit(
            process_single_svg, svg, output_folder): svg for svg in svg_files}
